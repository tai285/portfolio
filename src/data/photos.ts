...
export const photos: Photo[] = [
  ...
  },
  {
    ...
    alt: "Dorothy receiving the PRISM 2026 Consolation Prize for the Smart Inventory Management System Using RFID and IoT",
    category: "PRISM 2026",
    caption: "Consolation Prize — PRISM 2026",
  },
  {
    id: "prism-poster-demo",
    src: "photos/prism-2026/prism-poster-demo.jpg",
    alt: "Dorothy presenting the FYP poster and RFID hardware demo at the PRISM 2026 exhibition",
    category: "PRISM 2026",
    caption: "Poster & hardware demo — booth UG077",
  },
  {
    id: "prism-poster-portrait",
    src: "photos/prism-2026/prism-poster-portrait.jpg",
    alt: "Dorothy giving a thumbs up in front of her FYP poster at the PRISM 2026 exhibition",
    category: "PRISM 2026",
    caption: "At the exhibition booth",
  },
  {
    id: "prism-group-1",
    src: "photos/prism-2026/prism-group-1.jpg",
    alt: "Group photo of PRISM 2026 degree category award recipients on stage",
    category: "PRISM 2026",
    caption: "With fellow award recipients",
  },
  {
    id: "prism-group-2",
    src: "photos/prism-2026/prism-group-2.jpg",
    alt: "Another group photo of PRISM 2026 degree category award recipients on stage",
    category: "PRISM 2026",
    caption: "Award ceremony group photo",
  },
  {
    id: "prism-gold",
